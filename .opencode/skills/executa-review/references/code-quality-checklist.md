...
> Este checklist complementa o `AGENTS.md`. As regras do projeto (convenções React Native, TypeScript, nomenclatura, formatação) já estão definidas lá. Aqui ficam apenas os critérios de **verificação e inspeção** que exigem análise do código pronto.
